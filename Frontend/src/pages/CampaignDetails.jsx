...
// Donation Dialog with Optimistic Locking
        ...
        {step === 0 && (
          <Box>
            <Typography variant="body2" sx={{ color: isDark ? '#a0a0b8' : '#4a4a6a', mb: 2 }}>
              Select or enter your donation amount for "{campaign?.title}"
            </Typography>
          ...
          <Box>
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              ...
              <Button
                ...
                disabled={isProcessing || !lockAcquired}
                sx={{
                  flex: 2,
                  py: 1.5,
                  borderRadius: 2,
              ...
              >
                {isProcessing ? <CircularProgress size={24} color="inherit" /> : 'Confirm Donation'}
              </Button>
            </Box>
          </Box>
        )}
